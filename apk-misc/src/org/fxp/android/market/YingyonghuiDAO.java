...
import org.fxp.android.apk.tester.ApkManDao;
...
public class YingyonghuiDAO {
	private static YingyonghuiDAO self = null;
	...
	public static YingyonghuiDAO GetInstance() {
		if (self == null) {
			self = new YingyonghuiDAO();
			self.init();
			if (!instance_flag)
				self = null;
		}
