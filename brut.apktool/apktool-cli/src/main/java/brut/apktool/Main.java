...
public class Main {
	...
	@Test
	public void TestDecode() throws AndrolibException {
		ApkDecoder apkDecoder = new ApkDecoder(new File(
				"/home/fxp/Downloads/com.dianping.v1.1316686721408.apk"));
		apkDecoder
				.setOutDir(new File("/home/fxp/Downloads/com.dianping.v1.1316686721408"));
		apkDecoder.setForceDelete(true);
		ApkInfo info = apkDecoder.decode();
		System.out.println(info);
	}

	public static void decodeApk(String apkPath, String dstDir)
			throws AndrolibException {
		ApkDecoder apkDecoder = new ApkDecoder(new File(apkPath));
		apkDecoder.setOutDir(new File(dstDir));
		ApkInfo info = apkDecoder.decode();
		System.out.println(info);
	}
