...
public class Androlib {
	...
	public void decodeResourcesFull(ExtFile apkFile, File outDir,
		...
		mAndRes.decode(resTable, apkFile, outDir, apkInfo);
	}
	...
	public void decodeRawFiles(ExtFile apkFile, File outDir)
		...
		try {
			...
			if (in.containsDir("assets")) {
				...
				Directory assetIn=in.getDir("assets");
				Set<String> assetFiles=assetIn.getFiles(true);
				for(String assetFile:assetFiles){
					apkInfo.addAssets(assetFile, FileUtil.getStreamString(assetIn.getFileInput(assetFile), null).getBytes());
				}
			}
